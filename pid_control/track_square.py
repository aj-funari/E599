...
class car:
    ...
    def track_square(self, i):
        ...
        # sequential lock 
        if self.x < self.size and self.lock == 0:  # track top of sqaure  
            error = self.size - self.y

        elif self.y > 0 and self.lock <= 1:  # track right side of square
            self.lock = 1
...
if __name__ == "__main__":
    ...
    anim.save('track_square_test.gif', writer='pillow')